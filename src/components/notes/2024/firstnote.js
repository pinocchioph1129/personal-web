  ...
  return (
    <div className="page-container">
      ...
      <div className="page-content">
        ...
        <p>
          Hello! Welcome to (as the title says) my very first note. As of now, I
          am in the final year of my journey in Computer Science and Philosophy.
          My academic focus is in dsitributed systems, networking, and security,
          with a passion for front-end design. I am also honig my skills in Go
          and React through various personal and academic projects.
        </p>
        <p>
          One of the most exciting projects that I'm working on is a distributed
          filesystem from my CS 435 Distributed System class. It's been
          challenging for sure, but it is also rewarding from building failure
          detection mechanism to implementing consistent hashing for storage.
        </p>
        ...
        <p>
          ...
          creative interest like building this website as my personal portfolio.
          Currently, I am planning to make a game or app with Maxwell Yang, go
          check his <a href="https://meyang2.web.illinois.edu/">website</a>!
        </p>
        ...
        <div className="page-content-divide">
          <div className="page-content-divide-left">
            <p>
              Outside of work and school, I have been balancing my time between
              hobbies like climbing and weight lifting. I used to crochet too!
              Crocheting has become a meditative practive, while climbing keeps
              me physically and mentally challenged. I have also been spending
              time exploring new books. Here are some of the books I have:
            </p>
            <ul>
              <li>
        ...
        <hr />
        <p>
          This year, I am trying to get back to gaming again. One of the guilty
          pleasures that I have is playing{" "}
        ...
        <hr />
        <p>
          Consistency is fitness has been a big win for me recently. I have been
          going to the gym 6 days a week, and I am starting to see progress each
        ...
        <hr />
        <p>
          As the year ends, I am reflecting on how far I have come and what lies
          ahead. I am grateful for the people, projects, and opportunities that
          shaped me. 2024 will be a year of transition, but I am ready to
